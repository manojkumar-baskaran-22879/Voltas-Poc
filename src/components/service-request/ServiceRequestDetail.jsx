...
//         setData(result.data[0]); // API returns an array, take first element
//       } catch (err) {
...
// //     <div className="grid grid-cols-2 py-2 text-sm border-b border-slate-50 last:border-0">
...
//     <div className="flex gap-4">
//       <span className="text-slate-400">:</span>
//       {/* Use the helper here to prevent [object Object] or crashes */}
//       <span className="text-slate-800 font-medium">{formatValue(value)}</span>
//     </div>
//   </div>
// );
...
//     <h3 className="text-base font-bold text-slate-800 mb-4 mt-8 first:mt-0">{title}</h3>
//   );
...
//         </div>
//         {/* <button className="bg-blue-600 text-white px-6 py-1.5 rounded-md text-sm font-medium hover:bg-blue-700 shadow-sm">
//           Edit
//         </button> */}
//         <button 
...
//                <div className="flex gap-4">
//                  <span className="text-slate-400">:</span>
//                  <span className="text-slate-800 font-medium">{data.Street}</span>
//                </div>
//             </div> */}
//             <div className="grid grid-cols-2 py-2 text-sm">
//             <span className="text-slate-500">Street</span>
...
const ServiceRequestDetail = () => {
  ...
  const DataRow = ({ label, value }) => (
    <div className="grid grid-cols-2 py-3 text-base border-b border-slate-50 last:border-0">
