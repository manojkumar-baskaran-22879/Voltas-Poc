...
//     agencies: [],
//     products: [],
//     estimations: [] // Added for Estimation Name
//   });

//   // State for dynamic products in Step 3
...
//           // Fetching Estimations for the first dropdown requirement
...
//   const handleAddItem = () => {
//     setQuotedItems([...quotedItems, { productId: '', quantity: 0 }]);
//   };

//   const handleRemoveItem = (index) => {
//     if (quotedItems.length > 1) {
//       setQuotedItems(quotedItems.filter((_, i) => i !== index));
//     }
//   };
...
//         {/* Header omitted for brevity - same as your original code */}
...
//                 isSelect
//                 options={apiData.estimations.map(e => e.Subject)}
...
//                 isSelect
//                 options={apiData.serviceRequests.map(s => s.Name)}
...
//                 label="Agency"
//                 isSelect
//                 options={apiData.agencies.map(a => ({ label: a.Agency.name, value: a.Agency.id }))}
...
//                   className="flex items-center gap-1 bg-[#00579c] text-white px-3 py-1.5 rounded-full text-xs font-bold"
//                 >
//                   <Plus size={14} /> Add
//                 </button>
//               </div>
...
//                       className="w-full p-2.5 bg-white border border-slate-200 rounded-xl text-center text-sm"
//                     />
//                   </div>
//                   <button
...
//         {/* Navigation Footer same as your original code */}
...
//             <button onClick={onClose} className="text-[#00579c] text-sm font-bold">Cancel</button>
//             <button
//               onClick={() => stepNumber < 3 ? onStepChange(`step${stepNumber + 1}`) : onClose()}
//               className="bg-[#00579c] text-white px-10 py-2.5 rounded-full text-sm font-bold"
//             >
